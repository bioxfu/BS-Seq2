#/Users/tang58/Kai_BS/myown/select_DMR_Jacobsen_method/p_adjust_BH_v0.3.R
...
raw_p = read.table(p_file, head=T, sep = "\t", colClasses=c("character","character","character","numeric","character","numeric","character","numeric","character"));
# 1       2          3    4       5            6           7            8       9
